...
export const FEATURES = [
  {
    ...
    description:
      "Utilizamos apenas ingredientes de primeira qualidade selecionados.",
  },
  {
    icon: "favorite",
    ...
    image: imgComAmor,
    description:
      "Cada doce é preparado artesanalmente com carinho e dedicação.",
  },
  {
    icon: "local_shipping",
    ...
    image: entrega,
    description:
      "Entregas ágeis e seguras para você receber doces fresquinhos.",
  },
  {
    icon: "star",
